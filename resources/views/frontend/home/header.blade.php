            ...
            <nav class="navbar navbar-expand-lg">
                ...
                <div class="collapse navbar-collapse justify-content-end" id="navbarSupportedContent">
                    <ul class="navbar-nav">
                        <li class="dropdown">
                            ...
                            <div class="dropdown-menu">
                                <ul>
                                    ...
                                    <li><a class="dropdown-item nav-link nav_item" href="index-5.html">Electronics 1</a>
                                    </li>
                                    <li><a class="dropdown-item nav-link nav_item" href="index-6.html">Electronics 2</a>
                                    </li>
                                </ul>
                            </div>
                        </li>
                        <li class="dropdown">
                            <a class="dropdown-toggle nav-link" href="index.html#" data-bs-toggle="dropdown">Pages</a>
                            <div class="dropdown-menu">
                                <ul>
                                    <li><a class="dropdown-item nav-link nav_item" href="about.html">About Us</a></li>
                                    <li><a class="dropdown-item nav-link nav_item"
                                            href="https://bestwebcreator.com/shopwise/demo/contact.html">Contact Us</a>
                                    </li>
                                ...
                                <ul class="mega-menu d-lg-flex">
                                    ...
                                    <li class="mega-menu-col col-lg-3">
                                        <ul>
                                            ...
                                            <li><a class="dropdown-item nav-link nav_item"
                                                    href="https://bestwebcreator.com/shopwise/demo/shop-cart.html">Donec
                                    ...
                                    <li class="mega-menu-col col-lg-3">
                                        <ul>
                                            ...
                                            <li><a class="dropdown-item nav-link nav_item"
                                                    ...
                                                    condimentum</a></li>
                                            <li><a class="dropdown-item nav-link nav_item"
                                                    href="shop-product-detail-right-sidebar.html">Etiam ac rutrum</a>
                                            </li>
                                            <li><a class="dropdown-item nav-link nav_item"
                                                    href="shop-product-detail-thumbnails-left.html">Donec vitae ante
                                                    ante</a></li>
                                            <li><a class="dropdown-item nav-link nav_item"
                                                    href="shop-product-detail-thumbnails-left.html">Donec porttitor</a>
                                            </li>
                                        </ul>
                                    </li>
                                    <li class="mega-menu-col col-lg-3">
                        ...
                        <li class="dropdown">
                            <a class="dropdown-toggle nav-link" href="index.html#" data-bs-toggle="dropdown">Blog</a>
                            <div class="dropdown-menu dropdown-reverse">
                                <ul>
                                    <li>
                                        <a class="dropdown-item menu-link dropdown-toggler"
                                            href="index.html#">Grids</a>
                                        <div class="dropdown-menu">
                                            <ul>
                                                <li><a class="dropdown-item nav-link nav_item"
                                    ...
                                    <li>
                                        <a class="dropdown-item menu-link dropdown-toggler" href="index.html#">Single
                                            Post</a>
                                        <div class="dropdown-menu">
                                            <ul>
                                                <li><a class="dropdown-item nav-link nav_item"
                        ...
                        <li class="dropdown dropdown-mega-menu">
                            <a class="dropdown-toggle nav-link" href="index.html#" data-bs-toggle="dropdown">Shop</a>
                            <div class="dropdown-menu">
                                <ul class="mega-menu d-lg-flex">
                                        ...
                                        <ul class="d-lg-flex">
                                            ...
                                            <li class="mega-menu-col col-lg-4">
                                                <ul>
                                                    ...
                                                    <li><a class="dropdown-item nav-link nav_item"
                                                            href="https://bestwebcreator.com/shopwise/demo/shop-cart.html">Cart</a>
                                                    </li>
                                                    <li><a class="dropdown-item nav-link nav_item"
                        ...
                        <li><a class="nav-link nav_item"
                                href="https://bestwebcreator.com/shopwise/demo/contact.html">Contact Us</a></li>
                    </ul>
                </div>
                <ul class="navbar-nav attr-nav align-items-center">
                    ...
                    <li class="dropdown cart_dropdown"><a class="nav-link cart_trigger" href="index.html#"
                            data-bs-toggle="dropdown"><i class="linearicons-cart"></i><span
                                class="cart_count">2</span></a>
                        <div class="cart_box dropdown-menu dropdown-menu-right">
                            <ul class="cart_list">
                                <li>
                                    <a href="index.html#" class="item_remove"><i class="ion-close"></i></a>
                                    <a href="index.html#"><img src="assets/images/cart_thamb1.jpg"
                                ...
                                <li>
                                    <a href="index.html#" class="item_remove"><i class="ion-close"></i></a>
                                    <a href="index.html#"><img src="assets/images/cart_thamb2.jpg"
                            ...
                            <div class="cart_footer">
                                ...
                                <p class="cart_buttons"><a href="index.html#"
                                        class="btn btn-fill-line rounded-0 view-cart">View Cart</a><a
                                        href="index.html#" class="btn btn-fill-out rounded-0 checkout">Checkout</a>
                                </p>
                            </div>
                        </div>
                    </li>
